...
import org.twocache.twocachedemo.utils.RedisTemplateUtils;
          ...
          // objectObjectRedisTemplate.setValueSerializer(new FastJsonRedisSerializer<>(Object.class));
           ...
           for (Cache cache : caches) {
               if (cache instanceof CustomizedRedisCache) {
                   ...
                   // 将方法信息放到redis缓存
//                   RedisTemplate redisTemplate = RedisTemplateUtils.getRedisTemplate(lettuceConnectionFactory);
                   log.debug("org.twocache.twocachedemo.cache.CacheSupportImpl =>registerInvocation==>> method");
